    ...
    public function checkdbAction()
    {
        ...
        if(! $oRequest->isPost()) {
            ...
            return new ViewModel([
                ...
                'sVendor' => 'oneplace',
                'sModule' => 'oneplace-contact-basket',
            ]);
        } else {
            $sSetupConfig = $oRequest->getPost('plc_module_setup_config');

            $sSetupFile = 'vendor/oneplace/oneplace-contact-basket/data/install.sql';
            ...
            if($sSetupConfig != '') {
                $sConfigStruct = 'vendor/oneplace/oneplace-contact-basket/data/structure_'.$sSetupConfig.'.sql';
                ...
                $sConfigData = 'vendor/oneplace/oneplace-contact-basket/data/data_'.$sSetupConfig.'.sql';
            ...
            $oModTbl->insert([
                'module_key' => 'oneplace-contact-basket',
                'type' => 'plugin',
                'version' => \OnePlace\Contact\Basket\Module::VERSION,
                'label' => 'onePlace Contact Basket',
                'vendor' => 'oneplace',
            ]);
            ...
            $this->flashMessenger()->addSuccessMessage('Contact Basket DB Update successful');
